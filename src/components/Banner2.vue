                ...
                <div class="container">
                  <div class="col-md-11 centered">
                    <div class="prophet">
                      ...
                      <!-- end svg border -->
                      <div class="svg-fill">
                        <img src="/public/assets/hexa_fill_color.svg" alt="#" />
                      </div>
                      <div class="content">
        ...
        <div class="container">
          <div class="col-sm-3">
            <div class="content-wrapper">
              <div class="client">
                <a href="#">
                  <img src="/public/assets/images/09/client1.png" alt="#" />
                </a>
              </div>
              <!-- end client -->
            </div>
          ...
          <div class="col-sm-3">
            <div class="content-wrapper">
              <div class="client">
                <a href="#">
                  <img src="/public/assets/images/09/client2.png" alt="#" />
                </a>
              </div>
              <!-- end client -->
            </div>
          ...
          <div class="col-sm-3">
            <div class="content-wrapper">
              <div class="client">
                <a href="#">
                  <img src="/public/assets/images/09/client3.png" alt="#" />
                </a>
              </div>
              <!-- end client -->
            </div>
          ...
          <div class="col-sm-3">
            <div class="content-wrapper">
              <div class="client">
                <a href="#">
                  <img src="/public/assets/images/09/client4.png" alt="#" />
                </a>
              </div>
              <!-- end client -->
            </div>
